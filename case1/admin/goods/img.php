...
<div class="container">
    <div class="row">
        <h2>商品图片管理 
        <small class="text-danger">您正在编辑的是:《<?php echo $gname ?>》</small>
        </h2>
            ...
            <div class="col-md-3">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h4>
                            ID:<?php echo $val['id'] ?>
                            <?php echo $val['cover']?'<label class="label label-success">是封面</label>':'<label class="label label-danger">非封面</label>'; ?>
                        </h4>
                        <p>
